...
class Menu():
    ...
    def draw_cursor(self):
        self.draw_text((253, 0, 0), 'X', 40, self.cursor_rect.x, self.cursor_rect.y)
...
class  ScoreMenu ( Menu ):
    ...
    def display_menu(self):
        ...
        while self.run_display:
            ...
            i = 1
            for row in rows:
                highscore = pygame.font.Font(self.font_name,45).render(str('{0}'.format(row[0])), True, (255,255,255))
                highscorerect = highscore.get_rect()
                highscorerect = highscorerect.move(self.game.DISPLAY_W / 2  , 250 + i*highscorerect.bottom)
                compteur = pygame.font.Font(self.font_name,45).render(str(i), True, (255,255,255))
