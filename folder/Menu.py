...
class MainMenu(Menu):
    ...
    def display_menu(self):
        ...
        while self.run_display:
            ...
            self.game.draw_title('Main Menu', 150, self.game.DISPLAY_W / 2, self.game.DISPLAY_H / 2 - 150)
...
class  ControlMenu ( Menu ):
    ...
    def display_menu(self):
        ...
        while self.run_display:
            ...
            self.check_input()
            self.game.display.fill((25, 25, 166))
            self.game.draw_title('Control', 100, self.game.DISPLAY_W / 2 , self.game.DISPLAY_H / 2 - 150)
            self.game.draw_text((255, 255, 0), 'But: Tuer tout les MAN et manger les PELLETS', 20, self.game.DISPLAY_W / 2 , self.game.DISPLAY_H / 2 - 60)
            self.game.draw_text((255, 255, 0), 'Bouger PAN: Fleche directionnelle', 20, self.game.DISPLAY_W / 2 , self.game.DISPLAY_H / 2 - 0)

            self.game.draw_text((245, 200, 0), 'Appuyer sur Entree pour revenir au Menu', 10, self.game.DISPLAY_W / 2 , self.game.DISPLAY_H / 2 + 300)
            self.blit_screen()
...
class  ScoreMenu ( Menu ):
    ...
    def display_menu(self):
        ...
        while self.run_display:
            ...
            self.check_input()
            self.game.display.fill((25, 25, 166))
            self.game.draw_title('Score', 100, self.game.DISPLAY_W / 2, self.game.DISPLAY_H / 2 - 150)
            ...
            self.game.draw_text((255, 255, 0), 'Appuyer sur Entree pour revenir au Menu', 10, self.game.DISPLAY_W / 2 , self.game.DISPLAY_H / 2 + 300)
            self.blit_screen()
